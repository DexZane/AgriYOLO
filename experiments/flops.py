...
def calculate_complexity():
    # Define models to analyze (Synced with RunSotaComparison.py)
    models_to_check = [
        {"name": "AgriYOLO",  "cfg": "ultralytics/cfg/models/v10/YoloV10sTalFFN.yaml", "type": "v10"},
        {"name": "YOLOv10s",  "cfg": "ultralytics/cfg/models/v10/YoloV10sBaseline.yaml", "type": "v10"},
